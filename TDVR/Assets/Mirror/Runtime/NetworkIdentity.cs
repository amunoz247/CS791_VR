...
namespace Mirror
{
    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        public NetworkBehaviour[] NetworkBehaviours => m_NetworkBehaviours = m_NetworkBehaviours ?? GetComponentsInChildren<NetworkBehaviour>();
        ...
        internal void OnUpdateVars(NetworkReader reader, bool initialState)
        {
            ...
            {
                m_NetworkBehaviours = GetComponentsInChildren<NetworkBehaviour>();
            }
